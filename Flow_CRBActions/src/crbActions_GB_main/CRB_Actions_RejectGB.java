...
public class CRB_Actions_RejectGB
{
	// TestNG logger
        ...
        driver.get(url1);    
		 ...
		 // test to Login to the application as RIPC
		  ...
		  public void CRB_Wlcmpage() 
		  {
			  ...
			  Step04_CRB_Reject_GB login = new Step04_CRB_Reject_GB(driver);
			  login.login();
		  }
		  @Test(priority=1)
		  public void CRB_rej() 
		  {
			  ...
			  Step04_CRB_Reject_GB crbrej = new Step04_CRB_Reject_GB(driver);
			  crbrej.CRB_reject();
		  }
