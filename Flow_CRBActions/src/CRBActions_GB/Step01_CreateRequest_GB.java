...
public class Step01_CreateRequest_GB {
  ...
  private WebDriver driver;
	...
	public void Select_Requestor(){
		Requesting_Company.sendKeys(Excel.getCellValue(xlsFilePath,"Request_Creation",2,0));
...
File srcFile1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE) ;
	...
	try {
		String filename1 = "C:\\Users\\IBM_ADMIN\\Desktop\\Selenium\\CRBActions\\GB\\1_"+System.currentTimeMillis()+".png";
...
try {
	String filename2 = "C:\\Users\\IBM_ADMIN\\Desktop\\Selenium\\CRBActions\\GB\\2_"+System.currentTimeMillis()+".png";
...
File srcFile3 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE) ;
	...
	try {
		String filename3 = "C:\\Users\\IBM_ADMIN\\Desktop\\Selenium\\CRBActions\\GB\\3"+System.currentTimeMillis()+".png";
		FileUtils.copyFile(srcFile3, new File (filename3));
		...
		try {
			String filename4 = "C:\\Users\\IBM_ADMIN\\Desktop\\Selenium\\CRBActions\\GB\\4"+System.currentTimeMillis()+".png";
